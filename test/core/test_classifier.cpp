...
TEST(ClassifierTest, kSemilinearWithCoeff) {
    // 3 * (x & 0xFF)
...
TEST(ClassifierTest, kSemilinearPropagatesThroughAdd) {
...
TEST(ClassifierTest, kSemilinearPropagatesThroughNot) {
...
TEST(StructuralClassifierTest, kLinearMBABitwiseOnly) {
